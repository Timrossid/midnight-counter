...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      increment: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('increment',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 62 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      handOver: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`handOver: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const newSecretKey_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('handOver',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 78 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(newSecretKey_0.buffer instanceof ArrayBuffer && newSecretKey_0.BYTES_PER_ELEMENT === 1 && newSecretKey_0.length === 32)) {
          __compactRuntime.typeError('handOver',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(newSecretKey_0),
        ...
        const result_0 = this._handOver_0(context,
                                          partialProofData,
                                          newSecretKey_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
    ...
    this.impureCircuits = {
      ...
      handOver: this.circuits.handOver
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('handOver', new __compactRuntime.ContractOperation());
  ...
  _publicKey_0(sk_0, seq_0) {
    return this._persistentHash_0([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 58, 98, 117, 105, 108, 100, 101, 114, 58, 99, 111, 117, 110, 116, 101, 114, 58, 112, 107, 0, 0, 0, 0, 0]),
                                   __compactRuntime.convertFieldToBytes(32,
                                                                        seq_0,
                                                                        'counter.compact line 51 char 5'),
                                   sk_0]);
  }
  ...
  _increment_0(context, partialProofData) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('counter.compact line 75 char 20: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
  ...
  _handOver_0(context, partialProofData, newSecretKey_0) {
    const sk_0 = this._localSecretKey_0(context, partialProofData);
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_1 = this._publicKey_0(newSecretKey_0,
                                    _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                              partialProofData,
                                                                                              [
                                                                                               { dup: { n: 0 } },
