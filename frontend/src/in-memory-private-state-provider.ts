...
// In-memory private-state provider for the browser. The counter's only private
// state is the owner's secret key (32 bytes / 64 hex chars); persisting it in
// memory (scoped by contract address) is sufficient for a frontend session.
